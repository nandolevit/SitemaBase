...
namespace WinForms
{
    public partial class FormEstoqueContagem : Form
    {
        ...
        private void PreencherProdForm(ProdutoInfo produto)
        {
            ...
            {
                FormMessage.ShowMessegeWarning("Nenhum produto foi encontrando!");
            }
        }
        ...
        private void PreencherGridDataSource()
        {
            ...
            textBoxProdutoCod.Clear();
            //labelProdutoDescricao.Text = string.Empty;
            textBoxQuant.Text = "1";
            //labelValorUnit.Text = string.Empty;
            //labelQuantEstoque.Text = string.Empty;
